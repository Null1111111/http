...
Доля использования **HTTP/1.1** составляет примерно 20-25% в 2024 году. Около 60-70% всех веб-сайтов используют **HTTP/2**, его популярность возросла благодаря улучшенным возможностям производительности и поддержке большинства современных браузеров. **HTTP/3** активно внедряется и уже обслуживает около 10-15% мирового трафика. 
